...
// WS2812灯珠配置
#define WS2812_GPIO GPIO_NUM_5 // WS2812灯珠数据线GPIO
#define WS2812_LED_NUM 20       // 总灯珠数
#define WS2812_LED_NUM_USED 20  // 实际用的灯珠数

//2个舵机控制接口，分别控制上下转动和平面转动
#define SERVO_CONTROL_UPDOWN_GPIO GPIO_NUM_4    //舵机控制接口GPIO
#define SERVO_CONTROL_ROTATE_GPIO GPIO_NUM_16 //舵机控制接口GPIO
